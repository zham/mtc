...
class __TwigTemplate_ce68f336fd9e24e25ad7b1c0db19ab6b extends Twig_Template
{
...
\t\t\t\t\t<li class=\"current\"><a href=\"#\">Create Account</a></li>
...
\t\t\t\t\t\t\t<span class=\"custom radio\"></span> M.
\t\t\t\t\t\t</label>

\t\t\t\t\t\t<label for=\"radio2\">
\t\t\t\t\t\t\t<input name=\"radio1\" type=\"radio\" id=\"radio2\" style=\"display:none;\">
\t\t\t\t\t\t\t<span class=\"custom radio checked\"></span> Mme
\t\t\t\t\t\t</label>
\t\t\t\t\t\t<label>Prénom</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Prénom\" />
\t\t\t\t\t\t<label>Nom</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Nom\" />
\t\t\t\t\t\t<label>Adresse e-mail</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Email\" />
\t\t\t\t\t\t<label>Password</label>
\t\t\t\t\t\t<input type=\"password\" class=\"twelve\" placeholder=\"Password\" />
\t\t\t\t\t\t<br />
\t\t\t\t\t\t<br />
\t\t\t\t\t</fieldset>
\t\t\t\t\t<fieldset> 
...
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Nom\" />
\t\t\t\t\t\t<label>Société</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Société\" />
\t\t\t\t\t\t<label>Adresse</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Adresse\" />
\t\t\t\t\t\t<label>Adresse 2</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Adresse2\" />
\t\t\t\t\t\t<label>Code postal</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Code postal\" />
\t\t\t\t\t\t<label>Ville</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Ville\" />
\t\t\t\t\t\t<label>Pays</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Pays\" />
\t\t\t\t\t\t<label>Informations complémentaires</label>
\t\t\t\t\t\t<textarea rows=\"10\"></textarea>
\t\t\t\t\t\t<h5>Vous devez enregistrer au moins un numéro de téléphone.</h5>
\t\t\t\t\t\t<label>Téléphone domicile</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\"/>
\t\t\t\t\t\t<label>Téléphone portable</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\"/>
\t\t\t\t\t\t<label>Donnez un titre à cette adresse pour la retrouver plus facilement.</label>
\t\t\t\t\t\t<input type=\"text\" class=\"twelve\" placeholder=\"Mon adresse 1\" />
...
";
    ...
    {
        return "MtcShopBundle:shop:create_account-cmd02.html.twig";
    }
