...
class __TwigTemplate_ec461680edb725abbf6df36c0b9391d9 extends Twig_Template
{
    ...
    public function block_field($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($this->getContext($context, "object"), "username") != $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "user"), "username"))) {
            // line 16
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl($this->getAttribute($this->getContext($context, "sonata_user"), "getImpersonatingRoute"), array("_switch_user" => $this->getAttribute($this->getContext($context, "object"), "username"))), "html", null, true);
            echo "\" title=\"";
