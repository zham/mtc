...
class __TwigTemplate_dd1cb0a8f9bc860d1055e0311c44bc17 extends Twig_Template
{
...
\t\t\t\t\t<li class=\"unavailable\"><a href=\"#\">Validation</a></li>
\t\t\t\t\t<li class=\"current\"><a href=\"#\">Paiement</a></li>
\t\t\t\t</ul>
\t\t\t</div>
\t\t</div>
\t\t<div class=\"row\">\t\t\t
...
\t\t\t\t\t<p>Merci de choisir votre moyen de paiement afin de régler la somme de 87,37 € TTC</p>
\t\t\t\t\t<form class=\"custom\">
\t\t\t\t\t  <label for=\"radio1\">
\t\t\t\t\t\t<input name=\"radio1\" type=\"radio\" id=\"radio1\" checked> Réception en magasin
\t\t\t\t\t  </label>\t\t\t\t\t  
\t\t\t\t\t  <label for=\"radio2\">
\t\t\t\t\t\t<input name=\"radio1\" type=\"radio\" id=\"radio2\"> Paypal
\t\t\t\t\t  </label>
...
";
    ...
    {
        return "MtcShopBundle:shop:paiement-cmd04.html.twig";
    }
