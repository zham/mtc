...
class __TwigTemplate_6bc79f84f52323a3accfbf3b07782551 extends Twig_Template
{
...
\t<title>Single produits - Welcome to Mtcommande</title>
...
\t\t\t\t\t<li class=\"current\"><a href=\"#\">Article 01</a></li>
\t\t\t\t</ul>
\t\t\t</div>
\t\t</div>
\t\t<div class=\"row\">
...
\t\t\t\t<h2>
\t\t\t\t\tArticle 01
\t\t\t\t\t<span class=\"round label green\">En stock!</span>
\t\t\t\t\t<span class=\"round label red \">Epuisé!</span>
\t\t\t\t</h2>
...
\t\t\t\t<div class=\"row\">
\t\t\t\t\t<div class=\"twelve columns\">
\t\t\t\t\t\t<a href=\"#\"><img src=\"http://placehold.it/450x400\" alt=\"Article 01\" class=\"imgwithborder\"></a>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"row\">
\t\t\t\t\t<div class=\"twelve columns\">
\t\t\t\t\t\t<a href=\"#\"><img src=\"http://placehold.it/80x85\" alt=\"Article 01\" class=\"imgwithborder thumbnail\"></a>
\t\t\t\t\t\t<a href=\"#\"><img src=\"http://placehold.it/80x85\" alt=\"Article 01\" class=\"imgwithborder thumbnail\"></a>
\t\t\t\t\t\t<a href=\"#\"><img src=\"http://placehold.it/80x85\" alt=\"Article 01\" class=\"imgwithborder thumbnail\"></a>
\t\t\t\t\t\t<a href=\"#\"><img src=\"http://placehold.it/80x85\" alt=\"Article 01\" class=\"imgwithborder thumbnail\"></a>
\t\t\t\t\t\t<a href=\"#\"><img src=\"http://placehold.it/80x85\" alt=\"Article 01\" class=\"imgwithborder thumbnail\"></a>
...
\t\t\t\t<div class=\"row\">
\t\t\t\t\t<div class=\"twelve columns\">
\t\t\t\t\t\t<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition...Le Lorem Ipsum est simplement du faux texte employé dans la composition...</p>
\t\t\t\t\t\t<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition...</p>
\t\t\t\t\t\t<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition...</p>
\t\t\t\t\t\t<p>Le Lorem Ipsum est simplement du faux texte employé dans la composition...</p>
\t\t\t\t\t\t<p class=\"nice small radius green button\">12,00 € / ttc</p>
\t\t\t\t\t\t<br class=\"hide-on-desktops\"/>
\t\t\t\t\t\t<a href=\"#\" class=\"nice small radius blue button\">Ajouter au panier</a>
\t\t\t\t\t\t<br />
\t\t\t\t\t\t<br />
\t\t\t\t\t\t<dl class=\"tabs\">
\t\t\t\t\t\t\t<dd><a href=\"#simple1\" class=\"active\">En savoir plus</a></dd>
\t\t\t\t\t\t\t<dd><a href=\"#simple2\">Fiche technique</a></dd>
\t\t\t\t\t\t</dl>
...
";
    ...
    {
        return "MtcShopBundle:shop:single-produits.html.twig";
    }
